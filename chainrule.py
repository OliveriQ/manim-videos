...
class ChainRule(Scene):
  def construct(self):
    #The chain rule says that the derivative of a function  g(h(x)) is...
    #dg/dx = dg/dh * dh/dx
    ...
    pt1d = MathTex("\\text{But why does this work?}").scale(0.75).to_edge(UL)
